        ...
        <div class="mt-4">
            ...
            <div class="flex mt-4 mx-2 justify-center items-end">
                <div class="w-2/5 mr-2">
                    ...
                    <x-select id="category{{$index}}" class="block mt-1 w-full" type="text" name="expenses[{{$index}}][category]" :value="old('category')" required autofocus>
                ...
                <div class="w-2/5 ml-2">
                    ...
                    <x-jet-input id="amount{{$index}}" class="block mt-1 w-full" type="number" name="expenses[{{$index}}][amount]" :value="old('amount')" required />
                </div>
